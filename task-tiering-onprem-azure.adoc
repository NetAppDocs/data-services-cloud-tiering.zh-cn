...
如果您使用 3.9.25 或更高版本创建了控制台代理，那么一切就绪了。默认情况下，将设置自定义角色，该角色提供代理管理 Azure 网络内的资源和流程所需的权限。查看 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["所需的自定义角色权限"^]以及 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html#tiering["Cloud Tiering 所需的特定权限"^]。
