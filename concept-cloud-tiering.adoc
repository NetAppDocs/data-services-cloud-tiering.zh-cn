...
Cloud Tiering 许可证还可以与将数据分层到 IBM Cloud Object Storage 的集群共享。必须使用 System Manager 或ONTAP CLI 设置FabricPool配置，但link:task-licensing-cloud-tiering.html#apply-cloud-tiering-licenses-to-clusters-in-special-configurations["此类配置的许可是使用 Cloud Tiering 完成的。"]
...
link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-paygo-subscription["了解如何设置即用即付订阅"]。
...
购买 Cloud Tiering 许可证后，您需要将该许可证添加到NetApp Console。link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-byol-license["了解如何使用 Cloud Tiering BYOL 许可证"]。

如上所述，即使您已经购买了 BYOL 许可证，我们也建议您设置即用即付订阅。


NOTE: 从 2021 年 8 月开始，旧的 * FabricPool* 许可证被 * Cloud Tiering * 许可证取代。link:task-licensing-cloud-tiering.html#cloud-tiering-byol-licensing-starting-in-2021["详细了解 Cloud Tiering 许可证与FabricPool许可证的区别"]。
