...
https://www.netapp.com/data-services/tiering/tco-calculator/["使用云分层 TCO 计算器来查看您可以节省多少钱"^]。
...
Cloud Tiering 许可证还可以与将数据分层到 IBM Cloud Object Storage 的集群共享。FabricPool 配置必须使用 System Manager 或 ONTAP CLI 进行设置，但 link:task-licensing-cloud-tiering.html["此类配置的许可是使用 Cloud Tiering 完成的。"]
...
link:task-licensing-cloud-tiering.html["了解如何设置即用即付订阅"].
...
购买 Cloud Tiering 许可证后，您需要将该许可证添加到 NetApp Console。link:task-licensing-cloud-tiering.html["了解如何使用 Cloud Tiering BYOL 许可证"]。

如上所述，即使您已经购买了 BYOL 许可证，我们也建议您设置即用即付订阅。


NOTE: 自 2021 年 8 月起，旧的 *FabricPool* 许可证已被 *Cloud Tiering* 许可证取代。link:task-licensing-cloud-tiering.html["详细了解 Cloud Tiering 许可证与FabricPool许可证的区别"].
